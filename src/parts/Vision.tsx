  ...
  return (
    <div className="bg-[#3e8cc82a]" id="vision">
      <div className=" inline-flex my-12 ">
        <div className="w-[50%] max-md:w-[100%] mx-[5%] my-[5%]  ">
          <h1 className="text-[3vw] max-md:text-[9vw]  px-[2%] py-[2%] font-serif">
            OUR VISION
          </h1>
        ...
        <div className="w-[50%] max-md:hidden inline-flex items-center justify-center">
          <div

  ...
  return (
    <>
      <div className="bg-[#3e8cc82a]" id="contact">
        <h1 className="text-5xl  font-serif px-14 py-14  ">
          DROP-BY TO GRAB A COFFEE WITH US
        </h1>
        <div className=" px-[1rem] py-[1rem] grid grid-cols-2">
          <div className="px-10 py-14 text-3xl italic font-semibold font-serif text-center col-span-2">
          ...
          <div className="">
            <p className=" text-center text-3xl  h-full px-20 py-[15%]">
              ...
              <a
                ...
                className="hover:text-3xl text-[1.7rem] transition-all duration-500"
              >
                Drop Us An Email : info@muroojlubricants.com
              </a>
              <br />
              <br />
              <div className="text-[1.7rem]">
                ...
                <a
                  ...
                  className="hover:text-3xl text-[1.7rem] transition-all duration-500 px-2"
                >
                  +971-6-524-4899
                </a>
                /
